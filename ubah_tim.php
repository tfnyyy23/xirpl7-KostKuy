...
if( isset($_POST["submit"])){
    ...
    mysqli_query($koneksi, "UPDATE pwttim SET nama_kost='$nama_kost', alamat_kost='$alamat_kost', harga='$harga' where id_kost='$id'");
...
<body style="background: url(assets/img/17_-_Ornament_Pattern.jpg); background-size: cover; background-attachment: fixed;">
    ...
    <?php 
    $id = $_GET['id_kost'];
    $result = mysqli_query($koneksi, "select * from pwttim where id_kost='$id'");
